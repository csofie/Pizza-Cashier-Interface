...
LOCK TABLES `manageracc` WRITE;
/*!40000 ALTER TABLE `manageracc` DISABLE KEYS */;
INSERT INTO `manageracc` VALUES (1,'Default','123');
/*!40000 ALTER TABLE `manageracc` ENABLE KEYS */;
UNLOCK TABLES;
